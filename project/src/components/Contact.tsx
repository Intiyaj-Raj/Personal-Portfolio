    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-black border border-green-400/30 rounded-tr-[10px] rounded-bl-[10px] -tr-[30px] rounded-tr-[10px] rounded-bl-[10px] -bl-[30px] p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <input
                ...
                className="w-full bg-black border border-green-400/50 rounded-tr-[10px] rounded-bl-[10px]  px-4 py-3 text-green-400 font-mono"
              />
